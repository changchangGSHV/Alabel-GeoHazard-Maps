...
class ChoroplethAdmin(admin.ModelAdmin):
	...
	LOW_INFO_PATH = "/static/data/images/flood_low_img_info.png"
	MOD_INFO_PATH = "/static/data/images/flood_mod_img_info.png"
	HIGH_INFO_PATH = "/static/data/images/flood_high_img_info.png"
...
admin.site.register(Flood_Markers)
admin.site.register(Flood_Guidelines)
admin.site.register(Flood_Procedures)
admin.site.register(Flood_Choropleth, ChoroplethAdmin)